...
| C. 证据检索与状态 | `EvidenceRef`、fragment preview、KnowledgeStatus、混合检索 | 后端 evidence/status 契约可验证；C3 才接前端真实状态，chat/Agent 对 V2 evidence 的迁移留待 V2-F。不得把 C2 服务函数视为用户已经可通过聊天得到 V2 答案。 |
